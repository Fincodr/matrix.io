...
var Export = {
	...
	create: function(b_owner_id, owner_name, b_msg_id, event, data) {
		...
		var b_data = new Buffer(data, 'utf8');
		b_data_len.writeUInt16BE(data.length, 0);
		return Buffer.concat([b_source_id, b_hops, b_owner_id, b_msg_id, b_owner_name_len, b_owner_name, b_event_len, b_event, b_msg_len, b_data]);
	},
