        ...
        lines.forEach(function(line){
          if (line) {
            if (line[0] === '/') {
              ...
              self.broadcast('message', { msg: line, from: self.identity.name });
              /*
...
Matrix.prototype.broadcast = function(event, data) {
  ...
  if (self.connections.count>0) {
    ...
    // queue message
    self.messageQueue.push(payload);
  }
}

Matrix.prototype.banner = function() {
  console.log("matrix.io  Copyright (C) 2014  Mika 'Fincodr' Luoma-aho".grey);
  console.log("This program comes with ABSOLUTELY NO WARRANTY;".grey);
  console.log("This is free software, and you are welcome to redistribute it".grey);
  console.log("under certain conditions; see LICENSE for details.".grey);
  console.log("");
};
